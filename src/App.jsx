  ...
  const projects = [
    {
      ...
      logo: "src/assets/project/hidancer/logo.png",
      images: [
        "src/assets/project/hidancer/1.png",
        "src/assets/project/hidancer/2.png",
        "src/assets/project/hidancer/3.png",
        "src/assets/project/hidancer/4.png",
      ],
    },
    {
      title: "Checkmate",
      ...
      logo: "src/assets/project/checkmate/logo.png",
      images: [
        "src/assets/project/checkmate/1.jpg",
        "src/assets/project/checkmate/2.png",
        "src/assets/project/checkmate/3.png",
        "src/assets/project/checkmate/4.jpg",
      ],
    },
    {
      title: "Mayoo",
      ...
      logo: "src/assets/project/mayo/logo.png",
      images: [
        "src/assets/project/mayo/1.png",
        "src/assets/project/mayo/2.png",
        "src/assets/project/mayo/3.png",
      ],
    },
    {
      title: "FayrMob",
      ...
      logo: "src/assets/project/fayrmob/logo.png",
      images: [
        "src/assets/project/fayrmob/1.jpeg",
        "src/assets/project/fayrmob/2.jpeg",
        "src/assets/project/fayrmob/3.jpeg",
        "src/assets/project/fayrmob/4.jpeg",
        "src/assets/project/fayrmob/5.jpeg",
        "src/assets/project/fayrmob/6.jpeg",
        "src/assets/project/fayrmob/7.jpeg",
        "src/assets/project/fayrmob/8.jpeg",
      ],
    },
  ]
  ...
  const certificates = [
    {
      ...
      file: "src/assets/sertifikat/1.pdf",
    },
    {
      title: "Badan Penanggulangan Bencana Daerah – Sertifikat Magang",
      file: "src/assets/sertifikat/2.pdf",
    },
    {
    title: "PalComtech – Web Developer",
    file: "src/assets/sertifikat/3.pdf",
    },
    {
      title: "Google Cloud Skill Boost – Cloud Computing",
      file: "src/assets/sertifikat/4.pdf",
    },
    {
      title: "Google Cloud Skill Boost – Cloud Computing",
      file: "src/assets/sertifikat/5.pdf",
    },
    {
    title: "Google Cloud Skill Boost – Cloud Computing",
    file: "src/assets/sertifikat/6.pdf",
    },
    {
      title: "Google Cloud Skill Boost – Cloud Computing",
      file: "src/assets/sertifikat/7.pdf",
    },
    {
      title: "Dicoding – Web Programming Fundamentals",
      file: "src/assets/sertifikat/8.pdf",
    },
  ]
